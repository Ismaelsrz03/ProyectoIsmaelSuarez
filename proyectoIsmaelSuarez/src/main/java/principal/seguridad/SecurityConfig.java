...
public class SecurityConfig extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
            ...
            .antMatchers("/alumnoEntrenador","/alumnoEjercicio","/alumnoRutina","/perfilAlumno").hasRole("USER")
            .antMatchers("/entrenadorAlumno","/entrenadorEjercicio","/entrenadorRutina","/perfilEntrenador").hasRole("ENTRENADOR")
            .regexMatchers("/ejercicios/.","/rutinas/.","/entrenadores/.","/alumnos/.","/usuarios/.","/panel/.","/contrasena/.","/cuenta/.").hasRole("ADMIN")
            .regexMatchers("/alumnoEntrenador/.","/alumnoEjercicio/.","/alumnoRutina/.","/perfilAlumno/.").hasRole("USER")
            .regexMatchers("/entrenadorAlumno/.","/entrenadorEjercicio/.","/entrenadorRutina/.","/perfilEntrenador/.").hasRole("ENTRENADOR")
                    .and()
                    .formLogin()
                        .loginPage("/login")
                        .permitAll()
